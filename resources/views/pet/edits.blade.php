...
<div class="container">
    <h2>Edit Pet</h2>
    {{ Form::model($pet,['route' => ['petss.update',$pet->id],'method'=>'PUT', 'enctype'=>'multipart/form-data']) }}
    ...
    {{-- <div class="form-group"> 
        ...
        {!! Form::select('customer_id',$users, $pet->customer_id,['class' => 'form-control form-select']) !!}
    </div> --}}
